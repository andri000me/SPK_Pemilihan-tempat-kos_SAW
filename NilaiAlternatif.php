...
if (empty($_SESSION['username'])) {
 header("location:index.php"); // jika belum login, maka dikembalikan ke file form_login.php
  ...
  <head>
    ...
    <title>Admin - Nilai ALternatif</title>
    <!-- Bootstrap core CSS-->
            ...
            <div class="content-wrapper">
              <div class="container-fluid">
                ...
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active">Nilai Alternatif Kriteria</li>
                </ol>
                      ...
                      <div class="card-body">
                        <div class="table-responsive">
                          <?php   $resultss = mysqli_query($conn, " SELECT dataalternatif.id_alternatif, dataalternatif.nama_alternatif, alternatifvalue.k1, alternatifvalue.k2 ,alternatifvalue.k3 FROM dataalternatif
                           ...
                           <form  action="NilaiAlternatif.php" method="get">
  ...
  //   '$id','$id_kategori','$nama','$tipe','$stok','$harga_beli','$harga_jual')");
                      ...
                      mysqli_query($conn, "INSERT INTO Dpenjualan (id_dummy, nama_kategori, nama, tipe, harga, jumlah, total) VALUES (
                        '$id','$id_kategori','$nama','$tipe','$harga','$jumlah','$total')");
                      ...
                      $id = $_GET['id_user'];
                      mysqli_query($conn, "DELETE FROM Dpenjualan WHERE id_dummy = '$id'");
