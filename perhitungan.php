...
if((isset($_POST['pilihkos']))){
  $pilih = 1;

  if (isset($_POST['1'])) {
     $a = 1;
     $resultNormalisasi1 = mysqli_query($conn, "SELECT dataalternatif.id_alternatif, dataalternatif.nama_alternatif, kriteriavalue.k1, kriteriavalue.k2 ,kriteriavalue.k3 FROM dataalternatif 
                                   INNER JOIN kriteriavalue 
                                   ON dataalternatif.id_alternatif = kriteriavalue.id_alternatif WHERE dataalternatif.id_alternatif LIKE 1");
     while ($rows = mysqli_fetch_array($resultNormalisasi1)) {
                                          ...
                                          $data1[] = array('nama' => $rows['nama_alternatif'], 'total' => $total);
   ...
   if (isset($_POST['2'])) {
     ...
     $resultNormalisasi1 = mysqli_query($conn, "SELECT dataalternatif.id_alternatif, dataalternatif.nama_alternatif, kriteriavalue.k1, kriteriavalue.k2 ,kriteriavalue.k3 FROM dataalternatif 
                                   INNER JOIN kriteriavalue 
                                   ON dataalternatif.id_alternatif = kriteriavalue.id_alternatif WHERE dataalternatif.id_alternatif LIKE 2");
     while ($rows = mysqli_fetch_array($resultNormalisasi1)) {
   ...
   if (isset($_POST['3'])) {
     ...
     $resultNormalisasi1 = mysqli_query($conn, "SELECT dataalternatif.id_alternatif, dataalternatif.nama_alternatif, kriteriavalue.k1, kriteriavalue.k2 ,kriteriavalue.k3 FROM dataalternatif 
                                   INNER JOIN kriteriavalue 
                                   ON dataalternatif.id_alternatif = kriteriavalue.id_alternatif WHERE dataalternatif.id_alternatif LIKE 3");
     while ($rows = mysqli_fetch_array($resultNormalisasi1)) {
  ...
  if (isset($_POST['4'])) {
     ...
     $resultNormalisasi1 = mysqli_query($conn, "SELECT dataalternatif.id_alternatif, dataalternatif.nama_alternatif, kriteriavalue.k1, kriteriavalue.k2 ,kriteriavalue.k3 FROM dataalternatif 
                                   INNER JOIN kriteriavalue 
                                   ON dataalternatif.id_alternatif = kriteriavalue.id_alternatif WHERE dataalternatif.id_alternatif LIKE 4");
     while ($rows = mysqli_fetch_array($resultNormalisasi1)) {
...
$message = "Data Anda Telah Diproses. Silahkan Tunggu!";
...
?>
  ...
  <table class="table table-bordered" id="dataTablex" width="100%" cellspacing="0">
                                <thead>
                                  <tr>
                                    <th>Nama Kos</th>
                                    <th>Ranking Pemilihan Kos Anda</th>
                                 </tr>
                               </thead>

                               <tbody>
                                <?php     $nama  = array_column($data1, 'nama');
                                          $total = array_column($data1, 'total');

                                          array_multisort($total, SORT_DESC, $nama, SORT_DESC, $data1);
                            ...
                            $resultss = mysqli_query($conn, " SELECT dataalternatif.id_alternatif, dataalternatif.nama_alternatif, alternatifvalue.k1, alternatifvalue.k2 ,alternatifvalue.k3 FROM dataalternatif 
